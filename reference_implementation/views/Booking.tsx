        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="bg-white border-l-4 border-red-500 rounded shadow-sm p-4 flex gap-4">
             ...
             <div>
                ...
                <p className="text-sm text-gray-600 mt-1">As such, this shipment cannot be processed. Please contact us via chat or email ship@freightos.com for more information.</p>
             </div>
          </div>
